"""final idempotent categories/transactions (safe WHERE NOT EXISTS)

Revision ID: f30249e71447
Revises: 344bcd042bf6
Create Date: 2026-02-15 17:08:04.961871
...
def upgrade() -> None:
    ...
    # Seed defaults – safe WHERE NOT EXISTS (no ON CONFLICT needed)
    defaults = [
